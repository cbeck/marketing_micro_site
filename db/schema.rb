...
ActiveRecord::Schema.define(:version => 20121103203644) do

  create_table "refinery_community_posts", :force => true do |t|
    t.string   "blog_name"
    t.string   "blog_url"
  ...
  create_table "refinery_press_posts", :force => true do |t|
    t.string   "name"
    t.string   "url"
    t.text     "description"
    t.integer  "image_id"
